...
<html lang="en">
    ...
    <body>
            ...
            <section class="container-fluid Header Page_cursos">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item dropdown">
                              ...
                              <li class="nav-item dropdown active">
                                  <a class="nav-link dropdown-toggle activo" data-toggle="dropdown" href="" role="button" aria-haspopup="true" aria-expanded="false">SERVICIOS <i class="fa fa-chevron-down" aria-hidden="true"></i></a>
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="Servicios.html">Capacitación Bomberotecnia </a>
              ...
              <div class="container">
                <div class="row Conjunto_2 Page_cursos-row Page_servicios-row">
                  <div class="col-11 Subconjunto_2" data-aos="fade-right">
                    <section id="tab-1-title" class="Page_cursos_conjunto-1">
                      <i class="fas fa-fire Page_servicio_icon" aria-hidden="true"></i>
                  ...
                  <div class="col-lg-7 col-md-10 Page_cursos-col" data-aos="fade-up">
                        ...
                        <p class="Page_cursos-requisitos">Empresas que han adquirido este servicio</p>
                        <div class="Elegir-dcm__corbelen Servicio_cliente">
                  ...
                  <form class="col-lg-4 col-md-8 col-10 offset-lg-1 Constructor Page_cursos_form" data-aos="fade-left">
                    <h4 class="Page_cursos_title-inscribete">Adquiere este<br> servicio ahora</h4>
                    <label class="Form_label" for="opciones">Servicio</label>
                      <select class="form-control Form_input form-control-lg" id="opciones">
                        <option >Capacitación Bomberotecnia</option>
                      </select>
                      ...
                      <label class="Form_label" for="empresa">Empresa</label>
                      <input type="text" class="form-control Form_input" id="empresa" placeholder="Corbelen SAS">
        ...
        <!-- Cursos Slider! -->
        <div class="Cursos_slider">
          <div class="container">
            <h2 class="Titulo Cursos_slider-title">Otros Servicios que te pueden interesar</h2>
          <section class="row Cursos_slider-row">
            <div class="Curso_slider-item Servicios_slider-item">
              ...
              <a href="" class="Seguridad-salud__Link">Diseño de planes de Emergencia </a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-align-right Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link">Capacitación de trabajo<br> en espacios confinados </a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-briefcase Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link">Evaluación de puestos de trabajo </a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-th Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Diseño y actualización de matriz de peligros </a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-medkit Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Capacitación de primer<br> respondiente (Primeros auxilios)</a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-wheelchair Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Investigación de accidentes de trabajo</a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-search Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Inspección de equipos</a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-road Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Diseño del plan estratégico de seguridad vial</a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-fire-extinguisher Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Asesoría seguridad y salud en el trabajo</a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-list-ol Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Diseño y ejecución del sistema de gestión de seguridad y salud en el trabajo</a>
            </div>
            <div class="Curso_slider-item Servicios_slider-item">
              <i class="fas fa-medkit Dowload_icon--Service" aria-hidden="true"></i>
              <a href="" class="Seguridad-salud__Link Seguridad-salud__Link-diseno">Capacitación de primer respondiente (Primeros auxilios)</a>
            </div>                                                                                                                        
          </section>           
          </div>
        </div>
