...
<html lang="en">
    <head>
        ...
        <title>Curso Avanzado en Trabajo Seguro en Alturas - DCM - Antioquia</title>
                  ...
                  <div class="row">
                    <div class="col-12 Subconjunto_2" data-aos="fade-right">
                      <section id="tab-1-title" class="Page_cursos_conjunto-1">
                        <img src="img/curso-3.png" class="img-fluid Page_cursos_img" alt="Cliente-2">
                        <h1 class="Titulo Page_cursos_title">Avanzado en Trabajo Seguro en Alturas</h1>
                      </section>
                    </div>
                  </div>
