...
<html lang="en">
    <head>
        ...
        <title>Servicio de Diseño de Plan Estratégico de Seguridad Vial - DCM - Antioquia</title>
        <meta name="description" content="Servicio de Diseño de Plan Estratégico de Seguridad Vial - DCM - Antioquia, servicio para empresas relacionadas con la movilización vehicular que quieran crear herramientas prácticas para una adecuada implementación del plan estratégico de seguridad vial.">
        <!-- AOS css -->
                ...
                <div class="row">                                
                    <div class="col-lg-7 col-md-12 Page_cursos-col" data-aos="fade-up">
                          <section id="tab-1-title" class="Page_cursos_conjunto-1 Page_servicios_title_2">
                            <i class="fas fa-road Page_servicio_icon Page_servicio_icon-1" aria-hidden="true"></i>
                            <h1 class="Titulo Page_servicios_title">Diseño de Plan Estratégico de Seguridad Vial</h1>
                          </section>  
                          <p class="Page_cursos-description">Brindar herramientas prácticas para lograr una adecuada implementación del PESV (Plan Estratégico de Seguridad Vial) con el fin de optimizar los recursos y presupuestos de la organización y ayudar al cumplimiento de la meta de disminución de los índices de morbimortalidad asociados a accidentes de tránsito.</p>
